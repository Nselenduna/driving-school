    ...
    <>
      <nav className="bg-white/95 shadow-sm fixed w-full z-50 backdrop-blur-sm border-b border-gray-100">
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              <Link to="/" className="flex items-center group" onClick={closeMobileMenu}>
                ...
                <span className={`ml-3 font-semibold text-gray-900 transition-all duration-200 ${
            ...
            {shouldShowMobileLayout && (
              <div className="flex items-center">
                <button
                  ...
                  className="inline-flex items-center justify-center p-2 rounded-md text-gray-900 hover:text-red-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-500 transition-colors duration-200"
        ...
        {shouldShowMobileLayout && (
          <div
            ref={menuRef}
            className={`absolute top-16 left-0 w-full bg-white shadow-lg transform transition-transform duration-200 ease-in-out ${
          ...
          >
            <div className="px-4 pt-2 pb-3 space-y-1">
              ...
              <div className="pt-4 mt-4 border-t border-gray-200">
                <p className="text-sm text-gray-500 mb-4 px-3">Get in touch</p>
                <div className="space-y-3">
                  <a
                    href="tel:07377712688"
                    className="flex items-center text-gray-700 hover:text-red-600 transition-colors duration-200 px-3 py-2"
                  >
