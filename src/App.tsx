  ...
  return (
    <nav className="bg-white/90 shadow-sm fixed w-full z-50 backdrop-blur-sm">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="inline-flex items-center justify-center p-3 rounded-md text-gray-900 hover:text-red-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-500 border border-gray-300"
              aria-expanded="false"
            >
      ...
      <div className={`md:hidden absolute top-16 left-0 right-0 z-50 ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
        <div className="px-2 pt-2 pb-3 space-y-1 bg-white shadow-xl border-t border-gray-200 border-b border-gray-200">
          {navLinks.map((link) => (
            <div key={link.to} className="px-3 py-3 hover:bg-gray-50 rounded-md">
              <NavLink {...link} />
            </div>
          ))}
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-3 text-xl font-semibold">ZHWANE DRIVING SCHOOL</span>
                </div>
                <p className="text-gray-400 mb-4">
                  Professional driving instruction tailored to your needs. Learn with confidence from our experienced instructors.
                </p>
                <div className="flex space-x-4">
                  <button 
                    onClick={() => window.open('https://facebook.com/zhwanedrivingschool', '_blank')}
                  ...
                  <button 
                    onClick={() => window.open('https://instagram.com/zhwanedrivingschool', '_blank')}
                    className="text-gray-400 hover:text-white transition-colors duration-300"
                  ...
                  <button 
                    onClick={() => window.open('https://twitter.com/zhwanedrivingschool', '_blank')}
                    className="text-gray-400 hover:text-white transition-colors duration-300"
              ...
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link to="/fleet" className="text-base text-gray-300 hover:text-white">Our Fleet</Link>
                  </li>
                  <li>
                    <Link to="/blog" className="text-base text-gray-300 hover:text-white">Blog</Link>
                  </li>
                  <li>
                    <Link to="/book" className="text-base text-gray-300 hover:text-white">Book Now</Link>
                  </li>
                  <li>
                    <Link to="/share" className="text-base text-gray-300 hover:text-white">Share</Link>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li className="flex">
                    ...
                    <span className="text-gray-300">07377712688</span>
                  </li>
                  <li className="flex">
                    <svg className="h-6 w-6 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <span className="text-gray-300">info@zhwanedrivingschool.com</span>
                  </li>
                </ul>
              </div>
            </div>
