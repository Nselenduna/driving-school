                  ...
                  <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-lg transition-shadow duration-300">
                      ...
                      <p className="text-gray-600 italic">
                        "The instructors at Zhwane Driving School were incredibly patient and professional. 
                    ...
                    <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-lg transition-shadow duration-300">
                      <div className="flex items-center mb-4">
                        ...
                        <div className="ml-4">
                          <h3 className="text-lg font-semibold text-gray-900">Andrew Mpala</h3>
                          <p className="text-green-600 font-medium">Passed First Time</p>
                        </div>
                      </div>
                      <div className="flex text-yellow-400 mb-3">
                      ...
                      <p className="text-gray-600 italic">
                        "Indlela abafundisa ngayo , yenza ukuthi uzwisise ngokuphangisa.Ngiyajabula mpela ngokufundela ukutshayela imoto khonalapha eZhwane, ngithi 'Up Up ,Zhwane!!"
                      </p>
                    </div>
        ...
        <footer className="bg-gray-800">
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li className="text-gray-300">PO Box, Tsholotsho</li>
                  <li className="text-gray-300">+263 123 456 7890</li>
                  <li className="text-gray-300">info@ZhwaneDrivingSchool.com</li>
                </ul>
              </div>
              <div>
            ...
            <div className="mt-8 border-t border-gray-700 pt-8 text-center">
              <p className="text-gray-400">&copy; 2025 Lloyd IT Solutions. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
